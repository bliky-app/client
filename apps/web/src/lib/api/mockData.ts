...
export const ROLE_OWNER: Role = {
  ...
  nameRu: "Владелец",
  permissions: [
    "view_analytics", "view_all_schedule", "manage_all_schedule",
    "view_all_clients", "manage_all_clients", "manage_services",
    "view_staff", "manage_staff", "view_financials", "manage_workspace_settings"
  ],
  isSystem: true
}
...
export const ROLE_MASTER: Role = {
  id: "role-master",
  nameRu: "Мастер",
  permissions: ["view_own_schedule", "manage_own_schedule", "view_own_clients"],
  isSystem: true
}
...
export const ROLE_ADMIN: Role = {
  ...
  permissions: [
    "view_all_schedule", "manage_all_schedule",
    "view_all_clients", "manage_all_clients", "view_staff"
  ],
  isSystem: true
}
...
const mockUserPasha: User = {
  ...
  firstName: "Павел", lastName: "Иванов",
...
const mockUserIgor: User = {
  ...
  firstName: "Игорь", lastName: "Макаров",
...
const staffAnya: Member = {
  ...
  workspaceRole: ROLE_ADMIN, isAdministrator: true, mainCategory: categoryHair,
...
const staffKirillInSharedWorkspace: Member = {
  ...
  workspaceRole: ROLE_OWNER, isOwner: true, mainCategory: categoryHair,
...
const staffOwnerOfCoworking: Member = {
  ...
  workspaceRole: ROLE_OWNER, isOwner: true, mainCategory: categoryBarber,
  additionalCategories: []
}
...
if (todayKirillAppointments.length > 0) {
  ...
  const duration = lastAppointment.stages?.reduce((acc, s) => acc + (s.durationMinutes || 0), 0) || 0

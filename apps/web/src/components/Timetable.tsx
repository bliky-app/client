                      ...
                      {uniqueStaff.map(s => {
                        ...
                        return (
                          <td key={s.id} className="px-2 py-1.5 text-center">
                            <div className={`mx-auto w-10 h-10 rounded-xl flex flex-col items-center justify-center text-sm font-semibold transition-colors ${heatBg(count)} ${count > 0 ? "text-panel-text" : "text-panel-text-subtle"}`}>
                              {count > 0 ? count : ""}
                            </div>
                          </td>
                        )
